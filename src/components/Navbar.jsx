    ...
    return (
        <header className='fixed top-0 w-full h-16 bg-black bg-opacity-70 z-40'>
            <div className='container mx-auto px-5 flex items-center h-full'>
                <div>
                    <h1 className='text-3xl items-center font-extrabold px-2 bg-gradient-to-r from-teal-500 to-green-500 inline-block text-transparent bg-clip-text font-logoFont cursor-pointer active:scale-95 transition-all  tracking-wide italic'>moviemap</h1>
                </div>
                ...
                <div className='ml-auto flex items-center gap-5'>
                    ...
                    <div className='text-xl text-teal-500 cursor-pointer active:scale-90 transition-all'>
                        <MdOutlineLightMode />
                    </div>
                </div>
            </div>
